...
CREATE TABLE [referee-management-tool].dbo.competition_instance (
 ...
 ,CONSTRAINT KEY_competition_instance_competition_id UNIQUE (competition_id, season_id)
)
GO
...
CREATE TABLE [referee-management-tool].dbo.delegation_proposal (
  id INT IDENTITY
 ,draft_id INT NOT NULL
 ,CONSTRAINT PK_delegation_proposal_id PRIMARY KEY CLUSTERED (id)
 ,CONSTRAINT KEY_delegation_proposal_draft_id UNIQUE (draft_id)
)
GO

ALTER TABLE [referee-management-tool].dbo.delegation_proposal
ADD CONSTRAINT FK_delegation_proposal_match_id FOREIGN KEY (draft_id) REFERENCES dbo.delegation_draft (id) ON DELETE CASCADE ON UPDATE CASCADE
GO

CREATE TABLE [referee-management-tool].dbo.delegation_rejected (
  id INT IDENTITY
 ,draft_id INT NOT NULL
 ,CONSTRAINT PK_delegation_rejected_id PRIMARY KEY CLUSTERED (id)
 ,CONSTRAINT KEY_delegation_rejected_draft_id UNIQUE (draft_id)
)
GO

ALTER TABLE [referee-management-tool].dbo.delegation_rejected
ADD CONSTRAINT FK_delegation_rejected_match_id FOREIGN KEY (draft_id) REFERENCES dbo.delegation_draft (id) ON DELETE CASCADE ON UPDATE CASCADE
GO
...
CREATE TABLE [referee-management-tool].dbo.match (
 ...
 ,CONSTRAINT KEY_match UNIQUE (match_no)
)
GO
