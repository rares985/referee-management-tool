...
export const FetchOldUnavailabilities = (request) => {
  ...
  return (dispatch) => {
    ...
    axios
      .get('/api/unavailable/personal/old', GetRequest)
      .then((res) => {
...
export const FetchUpcomingUnavailabilities = (request) => {
  ...
  return (dispatch) => {
    ...
    axios
      .get('/api/unavailable/personal/upcoming', GetRequest)
      .then((res) => {
...
const DeleteUpcomingBegin = () => ({
  type: DELETE_UPCOMING_BEGIN,
});

const DeleteUpcomingSuccess = () => ({
  type: DELETE_UPCOMING_SUCCESS,
});

const DeleteUpcomingFailure = (error) => ({
...
export const DeleteUpcoming = (request) => {
  return (dispatch) => {
    ...
    axios
      ...
      .catch((err) => {
        dispatch(DeleteUpcomingFailure(err.error));
      });
  };
};
